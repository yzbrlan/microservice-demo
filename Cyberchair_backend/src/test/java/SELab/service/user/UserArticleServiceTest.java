...
class UserArticleServiceTest {
    ...
    void setUp() {
        ...
        File file = new File("src/test/resources/Author1/2020-05-11/DataBase.pdf");
...
//            System.exit(0);
        ...
        File file1 = new File("src/test/resources/DataBase.pdf");
...
//            System.exit(0);
    ...
    void uploadNewArticle() {
        ...
        Exception thrown1 = assertThrows(MeetingUnavaliableToOperateException.class,
                ()->userArticleService.uploadNewArticle(articleRequest,"src/test/resources/"));
        ...
        assertNotNull(userArticleService.uploadNewArticle(articleRequest,"src/test/resources/"));
    }
    ...
    void updateExistedArticle() {
        ...
        articleRepository.save(article);
        long id = article.getId();
        assertNotNull(userArticleService.updateExistedArticle(Long.toString(id),articleUpdateRequest,"src/test/resources/"));
    }
