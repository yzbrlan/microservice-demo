    ...
    export default{
        ...
        methods: {
            ...
            pcmInviteReq(){
                ...
                this.$axios.post('api/pcmember-service/meeting/pcmInvitation',
                    {
        ...
        mounted: function(){
            ...
            this.$axios.get('api/pcmember-service/meeting/invitationStatus',
            ...
            this.$axios.get('/api/user-service/util/users',
                {params:{fullname:''}}
            ).then(resp => {
                if(resp.data.responseCode == 200 && resp.data.responseMessage == "success"){
