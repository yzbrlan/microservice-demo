...
export default {
    ...
    methods: {
        beginSubmission(){
            let requestUrl = '/api/meeting-service/meeting/beginSubmission'
        ...
        review(strategy){
            let requestUrl = '/api/review-service/meeting/beginReview'
            let meetingName = this.$route.query.meetingName
            this.$axios.post(
            requestUrl, {
                meetingName: meetingName,
        ...
        beginDiscussion(){
            let requestUrl = '/api/meeting-service/meeting/publish'
            let meetingName = this.$route.query.meetingName
            this.$axios.post(
            requestUrl, {
                meetingName: meetingName
        ...
        publishFinalResult(){
            let requestUrl = '/api/meeting-service/meeting/finalPublish'
            let meetingName = this.$route.query.meetingName
            this.$axios.post(
            requestUrl, {
                meetingName: meetingName
    ...
    mounted: function(){
        let requestUrl = '/api/meeting-service/meeting/meetingInfo'
        let meetingName = this.$route.query.meetingName
        let that = this
        this.$axios.get(
            requestUrl, {
