  ...
  export default {
    ...
    methods: {
        loadMeetings(){
          ...
          let requestUrl = {
            queueingApplication:"/api/meeting-service/admin/queueingApplication",
            alreadyApplication:"/api/meeting-service/admin/alreadyApplication",
          };
          let that = this;
      ...
      loadingFunctions(){
        ...
        this.functions["queueingApplication"]["approve"] = function (item) {
          that.$axios.post('/api/meeting-service/admin/ratify',
            {
