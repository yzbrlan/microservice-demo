  ...
  export default {
    ...
    methods: {
      ...
      loadRelatedMeetings(){
        ...
        let requestUrl = {
          chairMeeting:"/api/meeting-service/user/chairMeeting",
          pcMemberMeeting: "api/pcmember-service/user/pcMemberMeeting",
          authorMeeting:"/api/article-service/user/authorMeeting",
          availableMeeting:"/api/meeting-service/user/availableMeeting"
        };
        let that = this;
