  ...
  export default {
    ...
    methods: {
      ...
      confirmReview:function(){
        ...
        let requestUrl = "/api/review-service/meeting/reviewConfirm";
        this.$axios.post(
          requestUrl,
          {
            articleId: articleId,
      ...
      commitReview:function(){
        ...
        let status = this.rebuttalStatus;
        let requestUrl = "/api/review-service/meeting/reviewer";
        let getJson =           {
          articleid: articleId,
          pcMemberName:pcMemberName,
          score:score,
        ...
        {
          requestUrl = "/api/review-service/meeting/updateReview"
          getJson =           {
            articleId: articleId,
            pcMemberName:pcMemberName,
            score:score,
      ...
      loadRebuttal:function() {
        this.articleId = this.$route.query.articleId;
        let that = this;
        let requestUrl = "/api/article-service/meeting/rebuttalInfo";
        this.$axios.get(
          requestUrl,
          {params: {
      ...
      loadReviewInfo:function() {
        ...
        let that = this;
        let requestUrl = "/api/review-service/meeting/alreadyReviewedInfo";
        this.$axios.get(
          requestUrl,
          {params: {
              articleId: articleId,
